...
minute_label <- if (minutes == 1) {
  "minute"
} else {
  "minutes"
}
second_label <- if (seconds == 1) {
  "second"
} else {
  "seconds"
}

cat(var_seconds, "seconds is", minutes, minute_label, "and", seconds, second_label, ".\n")
```
...
sprintf("%0.f squared is %0.f, and is the first number whose square exceeds %0.f.", pos_int, pos_int^2, num)
